    ...
    render() {
        return (
            <AboutContainer className='About'>
                ...
                <AboutText>I'm styding to become a front-end developer at KYH in Stockholm, Sweden. <br/> My skills include HTML, CSS, JavaScript and React.</AboutText>
                <AboutImg src={Skills}></AboutImg>
